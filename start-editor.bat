@echo off
REM ===================================================================
REM  selfsign-EDITOR starten (Windows) - einfach doppelklicken.
...
start "selfsign Analyse" cmd /k "%~dp0_backend.bat"
start "selfsign Editor"  cmd /k "cd /d %~dp0editor && echo === selfsign Editor (Port 5173) === && call npm run dev"
