@echo off
REM ===================================================================
REM  selfsign im TESTMODUS starten: so, wie es sich online verhaelt.
REM
...
REM  startest wieder mit start-selfsign.bat, ist alles wie vorher.
REM ===================================================================
cd /d "%~dp0"
...
echo.
echo   Willst du danach wieder durchkommen: selfsign-abo.bat
...
start "selfsign Backend (Testmodus)" cmd /k "%~dp0_backend-premium.bat"
