@echo off
REM Hilfsskript - wird von selfsign-premium-test.bat aufgerufen.
...
REM derselbe selfsign, nur mit angezogener Bezahlschranke.
cd /d "%~dp0"
...
echo === selfsign Backend (Port 8000) - TESTMODUS: Werkzeuge kosten ein Abo ===
